...
output_file("ipfwBasketballNumAthletes.html")

years = ['2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014']
divisions = ['Men Athletes', 'Women Athletes']

data = {'years' : years,
        'Men Athletes'   : [13, 11, 13, 12, 13, 13, 14, 13, 13, 13, 14],
        'Women Athletes'   : [15, 14, 15, 15, 15, 13, 16, 15, 13, 12, 14]
        }
...
p = figure(x_range=FactorRange(*x), plot_height=250, plot_width=1300, title="IPFW Number of Basketball Athletes Per Year",
