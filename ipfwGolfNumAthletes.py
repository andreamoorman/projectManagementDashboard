...
output_file("ipfwGolfNumAthletes.html")

years = [ '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014']
divisions = ['Men Athletes', 'Women Athletes']

data = {'years' : years,
        'Men Athletes'   : [6, 9, 8, 8, 6, 9, 9, 9, 9, 9, ],
        'Women Athletes'   : [5, 5, 7, 7, 7, 6, 7, 9, 7, 6]
        }
...
p = figure(x_range=FactorRange(*x), plot_height=250, plot_width=1300, title="IPFW Number of Golf Athletes Per Year",
