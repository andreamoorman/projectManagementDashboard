...
output_file("ipfwTennisNumAthletes.html")

years = ['2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014']
divisions = ['Men Athletes', 'Women Athletes']

data = {'years' : years,
        'Men Athletes'   : [7, 8, 9, 9, 9, 10, 10, 7, 8, 10, 9],
        'Women Athletes'   : [8, 8, 7, 6, 7, 8, 8, 7, 8, 8, 7]
        }
...
p = figure(x_range=FactorRange(*x), plot_height=250, plot_width=1300, title="IPFW Number of Tennis Athletes Per Year",
