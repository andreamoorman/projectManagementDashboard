...
output_file("ipfwSoccerNumAthletes.html")

years = ['2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014']
divisions = ['Men Athletes', 'Women Athletes']

data = {'years' : years,
        'Men Athletes'   : [19, 18, 17, 17, 22, 24, 25, 23, 21, 23, 20],
        'Women Athletes'   : [19, 17, 19, 16, 14, 20, 19, 20, 23, 23, 24]
        }
...
p = figure(x_range=FactorRange(*x), plot_height=250, plot_width=1300, title="IPFW Number of Soccer Athletes Per Year",
